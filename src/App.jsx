...
// function App() {
//   const countries = JSON.parse(JSON.stringify(Countries.countries));
...
//           Book List <span className="text-red-500">{books.length}</span>
//         </h1>
...
//           Student List: <samp className="text-red-500">{students.length}</samp>
//         </h1>
//         <div>
...
//           Total Countries:{" "}
//           <span className="text-blue-500">{countries.length}</span>
//         </h1>
//         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-4 gap-6 p-6">
...
const App = () => {
  ...
  return (
    <div>
      ...
      Product List <span className="text-blue-500">{Products.length}</span>
      </h1>
